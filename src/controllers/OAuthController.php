...
class OAuthController extends Controller {
	...
	public function getIndex()
	{
		...
		return View::make('Kiwing-IT-Solutions/kiwing-social::oauth/index', compact('connections'));
	}
	...
	public function getAuthenticated()
	{
		...
		return View::make('Kiwing-IT-Solutions/kiwing-social::oauth/authenticated', compact('user'));
	}
